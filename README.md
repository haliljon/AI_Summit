...
# 📖 AI_Summit <a name="about-project"></a>

**AI_Summit** is my Capstone Project, it is about the upcoming Summit.
...
Feel free to check the [issues page](https://github.com/haliljon/AI_Summit/issues).
